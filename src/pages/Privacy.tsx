...
<br />
        ...
        Phone number <br />
        Email address <br />
        Pickup and delivery addresses <br />
        Service details related to moving, furniture assembly, and furniture removal <br />
        Billing and payment information <br />
        Communications and correspondence with us <br />
...
<br />
        ...
        <p>
        Personal information is collected and used for the following purposes: <br />
        Providing and managing our services <br />
        Preparing quotes and scheduling services <br />
        Communicating service-related information <br />
        Processing payments and invoices <br />
        Improving operational efficiency and customer experience <br />
...
<br />
        ...
        <p>
        Moving United does not sell, rent, or trade personal information. <br />
        Personal information may be disclosed only to:
        <br />
        Employees or contractors who require the information to perform services <br />
        Third-party service providers such as payment processors <br />
...
<br />
        <h2>Contact Us</h2>
        <p>
        For privacy inquiries, access requests, or complaints under PIPEDA, please contact:{" "} <br />
        <a href="mailto:info@movingunited.ca" className="underline hover:text-primary">info@movingunited.ca</a> <br /> call{" "}
